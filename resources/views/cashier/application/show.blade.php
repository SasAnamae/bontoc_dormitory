...
<head>
    ...
    <style>
        ...
        .approved { text-align: right; margin-right: 160px; }
...
<div class="top-controls">
    <a href="{{ route('cashier.payments.create') }}" style="background-color: #ddd;">← Back to Applications</a>
    <div>
...
<div class="form-border">
    ...
    <p class="right"><strong><u>PETER JUNE D. DADIOS, PhD</u></strong></p>
